...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    PasosA.mt-4.color-acento-contenido.mb-5(tipo="n")
      .row
      ...
      .row
        .col-md-10.mb-4.mb-md-0
          p.Text-grande Se puede enviar información por correo electrónico o <em>links</em> de descarga para que los usuarios lo revisen con antelación y se pueda avanzar en la etapa de preguntas.
        .col-md-2
          figure
