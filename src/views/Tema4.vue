  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row
      .col-4.mb-4.mt-4.bgFondoTitulo
        p.text-white.p-3.mb-0.text-bold.Text-mediano Síntesis
